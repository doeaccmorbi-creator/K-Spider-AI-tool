...
self.addEventListener('fetch', event => {
  ...
  // 4b. ks-ads.js changes often (ad targeting, bug fixes) and MUST always
  //     be current — cache-first here was the root cause of "Advertisement"
  //     text / broken ad targeting persisting after fixes were deployed,
  //     because once cached this file was served forever with no
  //     revalidation. Always go to network first for this one file.
  if (url.origin === self.location.origin && url.pathname === '/ks-ads.js') {
